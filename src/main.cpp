...
static void ac_print_help() {
  fxmessage("Usage: audioconvert [options] source [destination]\n\n"
            ...
            "\n"
            "Format options:\n"
            "     --rename              Rename files according to format string\n"
            "     --format-template=<f> Set filename format (implies --rename)\n"
            "     --format-strip=<c>    Strip characters when renaming files\n"
            "     --format-encoding=<e> Set encoding to use when formatting files (default: ascii)\n"
